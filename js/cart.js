document.addEventListener('DOMContentLoaded', () => {
    const products = [
        { id: 1, name: 'Moss Agate Bowl 5"', price: '$100', images: ['Images/moss-agate-bowl/mossagate1.jpg'] },
        { id: 2, name: 'Crystal Sphere', price: '$110', images: ['Images/jasper-bowl/jasper1.jpg'] },
        ...
        { id: 5, name: 'Carnelian bowl 4"', price: '$100', images: ['Images/carnelian-bowl/3.png'] },
        { id: 6, name: 'Margaj bowl 5"', price: '$100', images: ['Images/margaj-bowl/1.png'] },
        { id: 7, name: 'Amethyst Sphere', price: '$110', images: ['Images/spheres/amethyst sphere/amethyst1.jpg'] },
        { id: 8, name: 'Jasper Sphere', price: '$110', images: ['Images/spheres/jasper sphere/jasper1.jpg'] },
        { id: 9, name: 'chakra tree', price: '$110', images: ['Images/trees/chakra small tree/chakra1.jpg'] },
        { id: 10, name: 'Black crystal pyramid', price: '$110', images: ['Images/pyramid/black/black1.jpg'] },
        { id: 11, name: 'White crystal pyramid', price: '$110', images: ['Images/pyramid/white/white1.jpg'] },
        { id: 12, name: 'Tiger Eye Cube', price: '$110', images: ['images/cubes/tiger eye cube/1717561915379.JPG'] }
    ];
